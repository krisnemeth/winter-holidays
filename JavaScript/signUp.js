...
document.querySelector('.btn-signup').addEventListener('click', function(){
    ...
    localStorage.setItem('storedUseremail', document.getElementById('userEmail').value)
})
...
if (localStorage.getItem('storedUserName')) {
    ...
    document.querySelector('.form-container').innerHTML = `<h2 class="text-center py-5">Welcome ${name}!</h2>`
} else {
